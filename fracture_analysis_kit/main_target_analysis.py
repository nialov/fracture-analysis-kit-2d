...
def main_multi_target_area(layer_table_df, results_folder, analysis_name, group_names_cutoffs_df, set_df, debug_logger):
    """
    ...
    :param debug_logger: Debugging logger.
    :type debug_logger: logging_tool.DebugLogger
